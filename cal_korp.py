...
from base_func import handle_output_decorator,main,cal_korpe
...
if __name__ == "__main__":
    ...
    output = f'/public/home/lzzheng/zgl/project/microbio/analysis2/statistic/korp'
