...
from base_func import handle_output_decorator,main,calculate_residue_hydrogen_bonds



@handle_output_decorator
def cal_func(fpdb):
    result = calculate_residue_hydrogen_bonds(fpdb)
    return result
...
if __name__ == "__main__":
    ...
    output = f'/public/home/lzzheng/zgl/project/microbio/analysis2/statistic/hydrogen_bonds'
